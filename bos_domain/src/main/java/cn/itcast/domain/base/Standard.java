...
// 命名查询
@NamedQueries(value = {@NamedQuery(name = "Standard.queryName2", query = "from Standard where name = ?"), @NamedQuery(name = "Standard.queryName3", query = "from Standard where minWeight < ?")})
