package cn.itcast.domain.take_delivery;
...
public class WayBill implements Serializable {
    private static final long serialVersionUID = -7064909492467734235L;
    @Id
    @GeneratedValue
    @Column(name = "C_ID")
    @org.springframework.data.annotation.Id // 映射索引库的主键
